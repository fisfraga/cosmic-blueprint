...
export function GeneKeysTab({ profile }: ProfileTabProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-500/5 to-purple-600/5 rounded-xl p-6 border border-purple-500/20">
      ...
      <div className="mb-6 p-4 bg-surface-base/30 rounded-lg">
      ...
      <div className="mb-6">
        <Link to="/gene-keys/sequences" className="group">
          ...
          <p className="text-theme-text-tertiary text-xs mb-3">Your Purpose — How you express your gifts in the world</p>
        </Link>
          ...
          {['lifesWork', 'evolution', 'radiance', 'purpose'].map((sphere) => {
            ...
            return (
              <Link
                ...
                className="bg-surface-base/50 rounded-lg p-3 hover:bg-surface-overlay transition-colors group"
              >
      ...
      <div className="mb-6">
        <Link to="/gene-keys/sequences" className="group">
          ...
          <p className="text-theme-text-tertiary text-xs mb-3">Your Relationships — Opening your heart through emotional healing</p>
        </Link>
      ...
      <div className="mb-6">
        <Link to="/gene-keys/sequences" className="group">
          ...
          <p className="text-theme-text-tertiary text-xs mb-3">Your Prosperity — Aligning your gifts with service to the whole</p>
        </Link>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      ...
      {chartCodonRings.length > 0 && (
        <div className="mb-6">
          <h3 className="text-theme-text-secondary text-sm font-medium mb-2 flex items-center gap-2">
            <span className="text-genekey-500">⬡</span> Codon Rings in Your Chart
          </h3>
          <p className="text-theme-text-tertiary text-xs mb-3">The biological codons activated by your Gene Keys profile</p>
