    ...
    <div className="space-y-8">
      ...
      <section className="flex gap-4 text-sm">
        <div className="bg-neutral-900/50 rounded-lg px-4 py-2 border border-neutral-800">
          ...
          <span className="text-neutral-500 ml-2">Codon Rings</span>
        </div>
        <div className="bg-neutral-900/50 rounded-lg px-4 py-2 border border-neutral-800">
          <span className="text-genekey-400 font-medium">64</span>
          <span className="text-neutral-500 ml-2">Gene Keys</span>
        </div>
      </section>
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  {keyNumbers.map(num => (
                    <span
                      key={num}
                      className="w-7 h-7 flex items-center justify-center text-xs font-medium bg-neutral-800 text-genekey-400 rounded"
                    >
                      {num}
                    </span>
                  ))}
