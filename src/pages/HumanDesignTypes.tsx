    ...
    <div className="space-y-8">
            ...
            return (
              <div key={hdType.id} className="flex gap-4 items-start">
                <div className="w-16 text-center">
                  ...
                  <p className="text-xs text-theme-text-tertiary mt-1">{hdType.percentage}</p>
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-theme-text-secondary mt-1">{hdType.role}</p>
                  <div className="flex gap-4 mt-2 text-xs">
                    <span className="text-theme-text-tertiary">
                      Strategy: <span className="text-theme-text-secondary">{strategy?.name}</span>
                    </span>
                    <span className="text-theme-text-tertiary">
      ...
      <section className="flex gap-4">
        ...
        >
          ...
          <p className="text-sm text-theme-text-secondary mt-1">Learn about decision-making authorities</p>
        </Link>
        <Link
