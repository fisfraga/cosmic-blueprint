    ...
    <div className="space-y-8">
      ...
      <section className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
        ...
        <div className="space-y-4">
          {lines.map((line) => {
            ...
            return (
              <div key={line.id} className="flex gap-4 items-start border-b border-theme-border-subtle pb-4 last:border-0 last:pb-0">
                ...
                <div className="flex-1">
                  <Link
                    ...
                    className="font-medium text-theme-text-primary hover:text-theme-text-primary transition-colors"
                  >
                    {line.archetype}
                  </Link>
                  <p className="text-theme-text-secondary text-sm mt-1">{line.theme}</p>
        ...
        <div className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2">
              ...
              <span className="text-theme-text-secondary">Investigator — Foundation through research</span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-humandesign-400">2</span>
              <span className="text-theme-text-secondary">Hermit — Natural talent, called out</span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-humandesign-400">3</span>
              <span className="text-theme-text-secondary">Martyr — Learning through experience</span>
            </li>
          </ul>
        </div>
        <div className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2">
              ...
              <span className="text-theme-text-secondary">Opportunist — Network and influence</span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-humandesign-400">5</span>
              <span className="text-theme-text-secondary">Heretic — Projection and solutions</span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-humandesign-400">6</span>
              <span className="text-theme-text-secondary">Role Model — Wisdom through process</span>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="flex gap-4">
        ...
        >
          ...
          <p className="text-sm text-theme-text-secondary mt-1">See how lines combine into profiles</p>
        </Link>
        <Link
          to="/human-design"
          className="flex-1 p-4 bg-surface-base/50 rounded-xl border border-theme-border-subtle hover:border-theme-border-subtle transition-colors"
        >
          ...
          <p className="text-sm text-theme-text-secondary mt-1">Each gate has 6 lines</p>
        </Link>
      </section>
    </div>
  );
