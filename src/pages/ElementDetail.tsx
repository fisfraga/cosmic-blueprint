              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                {element.zodiacSignIds.map((sid) => {
                  ...
                  return (
                    <div
                      key={sid}
                      className={`rounded-xl border p-4 text-center transition-colors hover:bg-surface-interactive/30 cursor-pointer ${colorClass}`}
            ...
            <section className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
              ...
              <div className="flex flex-wrap gap-2">
                {elementGeneKeys.map((gk) => (
                  <div
                    key={gk.id}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-genekey-500/10 hover:bg-genekey-500/20 rounded-lg transition-colors text-sm group cursor-pointer"
