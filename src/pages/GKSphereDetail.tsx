        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          ...
          {partnerSphere && (
            <section className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
              ...
              <div
                className="flex items-center gap-4 p-4 bg-genekey-500/10 rounded-lg hover:bg-genekey-500/20 transition-colors cursor-pointer"
                onClick={() => handleEntityClick(partnerSphere as unknown as EntityInfo)}
              >
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {sequenceSpheres
                ...
                .map((s) => (
                  <div
                    key={s.id}
                    className="flex items-center gap-3 p-3 bg-surface-overlay rounded-lg hover:bg-surface-raised transition-colors cursor-pointer"
