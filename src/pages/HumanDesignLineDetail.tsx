  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <header className="text-center py-8">
        ...
        <p className="text-theme-text-secondary">{line.theme}</p>
      ...
      <section className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
        <p className="text-theme-text-secondary leading-relaxed">{line.description}</p>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-4">
        <div className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle">
          ...
          <p className="text-theme-text-secondary">{line.inPersonality}</p>
        </div>
        <div className="bg-gradient-to-br from-red-500/10 to-red-600/5 rounded-xl p-6 border border-red-500/20">
          ...
          <p className="text-theme-text-secondary">{line.inDesign}</p>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 rounded-xl p-6 border border-green-500/20">
          ...
          <p className="text-theme-text-secondary">{line.healthyExpression}</p>
        </div>
        <div className="bg-gradient-to-br from-red-500/10 to-red-600/5 rounded-xl p-6 border border-red-500/20">
          <h2 className="font-serif text-xl mb-3 text-red-300">Unhealthy Expression</h2>
          <p className="text-theme-text-secondary">{line.unhealthyExpression}</p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-humandesign-500/10 to-humandesign-600/5 rounded-xl p-6 border border-humandesign-500/20">
        ...
        <p className="text-theme-text-secondary leading-relaxed">{line.practicalGuidance}</p>
      </section>
      ...
      {gkLine && (
        <section className="bg-gradient-to-br from-genekey-500/10 to-genekey-600/5 rounded-xl p-6 border border-genekey-500/20">
          ...
          <div className="flex items-start gap-4 p-4 bg-surface-base/50 rounded-lg border border-theme-border-subtle">
            ...
            <div>
              <p className="text-theme-text-primary font-medium">{gkLine.archetype}</p>
              {gkLine.theme && (
                <p className="text-theme-text-secondary text-sm mt-1 italic">{gkLine.theme}</p>
              )}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
            {profilesWithLine.map((profile) => (
              <Link
                ...
                className="p-3 bg-surface-overlay rounded-lg hover:bg-surface-raised transition-colors"
              >
      ...
      <div className="text-center pt-4">
        <Link to="/human-design/lines" className="text-theme-text-secondary hover:text-theme-text-primary transition-colors">
          &#8592; Back to Lines
        </Link>
      </div>
    </div>
