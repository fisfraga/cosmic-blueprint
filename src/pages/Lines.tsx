      ...
      <section className="space-y-4">
        {allLines.map((line, index) => (
          ...
          >
            <Link
              to={`/lines/${line.id}`}
              className="block bg-neutral-900/50 rounded-xl p-6 border border-neutral-800 hover:border-indigo-500/30 hover:bg-neutral-900/80 transition-all"
            >
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h2 className="font-serif text-xl text-white">{line.archetype}</h2>
                ...
                {/* Arrow */}
                <div className="text-neutral-600 self-center">
      ...
      <section className="bg-gradient-to-br from-indigo-500/10 to-indigo-600/5 rounded-xl p-6 border border-indigo-500/20">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-3 bg-neutral-900/50 rounded-lg">
            ...
            <p className="text-neutral-400 text-xs mt-1">Foundation & Network</p>
          </div>
          <div className="p-3 bg-neutral-900/50 rounded-lg">
            <p className="text-indigo-400 font-medium">Line 2 & Line 5</p>
            <p className="text-neutral-400 text-xs mt-1">Natural Gift & Universalization</p>
          </div>
          <div className="p-3 bg-neutral-900/50 rounded-lg">
            <p className="text-indigo-400 font-medium">Line 3 & Line 6</p>
            <p className="text-neutral-400 text-xs mt-1">Experience & Integration</p>
          </div>
        </div>
      </section>
    </div>
