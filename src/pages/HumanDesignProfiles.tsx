    ...
    <div className="space-y-8">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-neutral-700 text-left">
                <th className="py-2 px-3 text-neutral-400">Profile</th>
                <th className="py-2 px-3 text-neutral-400">Name</th>
                <th className="py-2 px-3 text-neutral-400 hidden md:table-cell">Life Theme</th>
              </tr>
            </thead>
            <tbody>
              {profiles.map((profile) => {
                ...
                return (
                  <tr key={profile.id} className="border-b border-neutral-800 hover:bg-neutral-800/50">
      ...
      <section className="grid md:grid-cols-2 gap-4">
        <div className="bg-neutral-900/50 rounded-xl p-6 border border-neutral-800">
          <h3 className="font-serif text-lg mb-3 text-neutral-200">Personality Line (Conscious)</h3>
      ...
      <section className="flex gap-4">
        ...
        >
          ...
          <p className="text-sm text-neutral-400 mt-1">Learn about the 6 individual lines</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="text-sm text-neutral-400 mt-1">Explore the five HD types</p>
        </Link>
      </section>
    </div>
  );
