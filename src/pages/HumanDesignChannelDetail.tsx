        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          ...
          <section className="bg-surface-base/50 rounded-xl p-6 border border-theme-border-subtle text-center">
            <div className="flex items-center justify-center gap-4 flex-wrap">
              {center1 && (
                <div
                  className="px-4 py-2 bg-surface-raised rounded-lg hover:bg-surface-interactive transition-colors cursor-pointer"
                  onClick={() => handleEntityClick(center1 as unknown as EntityInfo)}
                >
              ...
              {!center1 && (
                <div className="px-4 py-2 bg-surface-raised rounded-lg">
                  <p className="text-theme-text-secondary text-xs">Center</p>
                  <p className="text-theme-text-primary font-medium">{channel.center1Id}</p>
                </div>
              )}
              ...
              {center2 && (
                <div
                  className="px-4 py-2 bg-surface-raised rounded-lg hover:bg-surface-interactive transition-colors cursor-pointer"
                  onClick={() => handleEntityClick(center2 as unknown as EntityInfo)}
                >
                  <p className="text-theme-text-secondary text-xs">Center</p>
              ...
              {!center2 && (
                <div className="px-4 py-2 bg-surface-raised rounded-lg">
                  <p className="text-theme-text-secondary text-xs">Center</p>
                  <p className="text-theme-text-primary font-medium">{channel.center2Id}</p>
                </div>
              )}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              {gate1 && (
                <div
                  className="bg-surface-base/50 rounded-xl p-5 border border-theme-border-subtle hover:border-humandesign-500/50 hover:bg-surface-base transition-all group cursor-pointer"
                  onClick={() => handleEntityClick(gate1 as unknown as EntityInfo)}
                >
              ...
              {gate2 && (
                <div
                  className="bg-surface-base/50 rounded-xl p-5 border border-theme-border-subtle hover:border-humandesign-500/50 hover:bg-surface-base transition-all group cursor-pointer"
                  onClick={() => handleEntityClick(gate2 as unknown as EntityInfo)}
                >
                  <div className="flex items-start gap-4">
          ...
          {(geneKey1 || geneKey2) && (
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {geneKey1 && (
                  <div
                    className="bg-surface-base/50 rounded-xl p-5 border border-theme-border-subtle hover:border-genekey-500/50 hover:bg-surface-base transition-all group cursor-pointer"
                    onClick={() => handleEntityClick(geneKey1 as unknown as EntityInfo)}
                  >
                    <div className="flex items-start gap-4">
                ...
                {geneKey2 && (
                  <div
                    className="bg-surface-base/50 rounded-xl p-5 border border-theme-border-subtle hover:border-genekey-500/50 hover:bg-surface-base transition-all group cursor-pointer"
                    onClick={() => handleEntityClick(geneKey2 as unknown as EntityInfo)}
                  >
                    <div className="flex items-start gap-4">
